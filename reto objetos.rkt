...
;^;;;;;;;;;;;;;;; new productions for oop ;;;;;;;;;;;;;;;;
    ...
    (method-type ("public") public-type)
    (method-type ("private") private-type)
    (method-type ("protected") protected-type)
...
(define method-decl->method-t
  (lambda (md)
    (cases method-decl md
      (a-method-decl (method-t method-name ids body) method-t))))

(define method-decl->method-name
  (lambda (md)
    (cases method-decl md
      (a-method-decl (method-t method-name ids body) method-name))))

(define method-decl->ids
  (lambda (md)
    (cases method-decl md
      (a-method-decl (method-t method-name ids body) ids))))

(define method-decl->body
  (lambda (md)
    (cases method-decl md
      (a-method-decl (method-t method-name ids body) body))))
...
(define roll-up-method-decls
  (lambda (c-decl t super-name field-ids)
    (map
      (lambda (m-decl)
        (a-method t m-decl super-name field-ids))
...
(define method->type-m
  (lambda (meth)
    (cases method meth
      (a-method (type-m meth-decl super-name field-ids) type-m))))

(define method->method-decl
  (lambda (meth)
    (cases method meth
      (a-method (type-m meth-decl super-name field-ids) meth-decl))))

(define method->super-name
  (lambda (meth)
    (cases method meth
      (a-method (type-m meth-decl super-name field-ids) super-name))))

(define method->field-ids
  (lambda (meth)
    (cases method meth
      (a-method (type-m method-decl super-name field-ids) field-ids))))
